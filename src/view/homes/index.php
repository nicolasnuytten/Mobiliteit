<main>
  ...
  <article class="specialday">
      ...
      <p class="text">Autoloze zondag is een speciale dag voor heel Europa. Op deze dag worden centra van steden en gemeten afgesloten voor auto’s. Bijvoorbeeld in Brussel kan je gaan rond fietsen op de straat of door de tunnels waar je normaal met de auto zou rijden. Natuurlijk zijn er op deze plaatsen verschillende andere acties gepland rond deze week van de mobiliteit.</p>
      <a href="#" class="button">Bekijk het in jouw buurt</a>
  ...
  <section class="home-acties">
    ...
    <section class="actie">
      ...
      <div class="actie-info">
        <h2 class="acite-title">Activiteit</h2>
